...
const App = () => {
  return (
   <>
    <Header title="Super Puper Poke" descr="This is not only the game"/>
    ...
    <Layout
       ...
       <div className="flex">
         {
           cardData.map(item => <PokemonCard key={item.id} {...item} />)
         }
       </div>

    </Layout>
    <Layout title="Description of the game" descr="Coming soon..." urlBg={bgImage3} />
    <Footer />
   </>
  );
}
